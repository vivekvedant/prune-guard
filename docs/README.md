...
- `cross-platform-build-distribution.md`: Linux/macOS build matrix, Linux `.deb` packaging with daemon+systemd oneshot/timer install payload, checksums, and fail-closed release gating
