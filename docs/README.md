...
- `cross-platform-build-distribution.md`: Linux/macOS/Windows build matrix, Linux `.deb` packaging + Windows `.zip` packaging, checksums, and fail-closed release gating
